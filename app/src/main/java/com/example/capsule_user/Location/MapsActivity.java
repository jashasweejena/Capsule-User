package com.example.capsule_user.Location;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        trackChanges().observe(this, new Observer<String>() {
            @Override
            public void onChanged(String s) {
                String longitude = s.split(":")[0];
                String latitude = s.split(":")[1];

                Log.d(TAG, "onChanged:  Longitude: " + longitude + " Latitude: " + latitude);
